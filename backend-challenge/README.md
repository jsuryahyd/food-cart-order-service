...
- Alternatively, in a large scale system, it can be broken in to separate services - Orders Service, Products Service and Promo Service. 
...
- #### Worker: ("Implementation Details" below)
...
- Port 8080 is required by the api server
- Open the url for scalar api client, served at `http://localhost:8080/scalar`
- Loading large files:
	...
	- Database is cleared and seeded everytime the application is rebuilt. So, Product Ids change after re building the api service.

### System Requirements For Coupons Cache
- Naive Approach:✖️
